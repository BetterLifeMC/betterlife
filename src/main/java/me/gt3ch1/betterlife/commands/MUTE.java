    ...
    public boolean onCommand(@NotNull CommandSender sender, @NotNull Command c, @NotNull String command, String[] args) {
        switch (args.length) {
            case 1 -> {
                ...
                boolean getCurrentMuteState = BetterLife.bl_player.getPlayerToggle(otherPlayer.getUniqueId(), BL_PLAYER_ENUM.MUTE_PER_PLAYER);
                ...
                BetterLife.bl_player.setPlayerToggle(otherPlayer.getUniqueId(), BL_PLAYER_ENUM.MUTE_PER_PLAYER);
                return true;
            }
            default -> {
